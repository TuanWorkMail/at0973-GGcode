...
function onEndSession(data){
    ...
    if(data.result === 'a') document.getElementById('waiting').innerHTML = 'VICTORY<br/>click to replay';
    else document.getElementById('waiting').innerHTML = 'DEFEAT<br/>click to replay';
}
